    ...
    app.get("/oauth2callback", async (req, res) => {
        ...
        try {
            ...
            if (!tokens.refresh_token) {
                console.warn("No refresh_token returned. See instructions in README: remove previous app access and retry (prompt=consent + access_type=offline must be used).");
            }
